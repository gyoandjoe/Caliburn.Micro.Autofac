...
using Sample_WPF_CastleProxy.DI.Modules;


namespace Sample_WPF_CastleProxy.DI
{
    ...
    {
        public AutofacBootstrapper(bool useApplitacion = true) :base(useApplitacion)
        {
            Initialize();
            this.DisplayRootViewFor(typeof(TRootViewModel));                       
        }
        ...
        { //  allow base classes to change bootstrapper settings
            ...
            {
                dynamic viewModelType = modelType;

                dynamic viewModelTypeName = viewModelType.FullName;
            ...
            //builder.RegisterModule<CastleProxyAutoSubscriptionModule>();
            //Register Interceptors in Module
            builder.RegisterModule<InterceptorsAutosubscriptionModule>();
            ...
            //Register ViewModels
            builder.RegisterModule<ViewModelsAutosubscriptionModule>();
